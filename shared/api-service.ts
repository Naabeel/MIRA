...
class ApiService {
  ...
  private getMockAutoResponse(request: AutoResponseRequest): AutoResponseResponse {
    const { category, catalyst, ticket_details } = request;
    ...
    const htmlContent = `
      <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px; background-color: #ffffff;">
        <div style="border-bottom: 3px solid #1E3A8A; padding-bottom: 20px; margin-bottom: 30px;">
          ...
          <p style="color: #6B7280; margin: 5px 0 0 0; font-size: 14px;">Automated response generated by MIRA</p>
        </div>

        <div style="margin-bottom: 25px;">
          <p style="color: #374151; line-height: 1.6; margin: 0 0 15px 0;">Dear ${member.NAME},</p>
          <p style="color: #374151; line-height: 1.6; margin: 0 0 15px 0;">
            Thank you for contacting GLG regarding your ${category.toLowerCase()} ${catalyst.toLowerCase()} request.
